...
public class vpAlignment {
	...
	public void writeNN(String source, String target, boolean flag) {
		...
		try {
			Writer bw = new BufferedWriter(new OutputStreamWriter(
				    new FileOutputStream(source + ".vm"), "UTF-8"));

			Writer bw1 = new BufferedWriter(new OutputStreamWriter(
				    new FileOutputStream(target + ".vm"), "UTF-8"));
			if (flag)
	...
	public static void main(String[] args) {
		...
		String source = workDir + languagePair[0] + domain[1] + "train.bn";
		String target = workDir + languagePair[0] + domain[1] + "train.hi";
		vpAlignment ne = new vpAlignment();
